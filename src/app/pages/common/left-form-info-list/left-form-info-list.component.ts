...
@Component({
  selector: 'app-left-form-info-list',
  templateUrl: './left-form-info-list.component.html',
  styleUrls: ['./left-form-info-list.component.scss']
})
export class LeftFormInfoListComponent {
